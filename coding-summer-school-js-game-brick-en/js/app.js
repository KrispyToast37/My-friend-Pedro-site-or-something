...
var paddleColor = "#5c58cd";
// The color of the brick
var brickColor = "#5c58cd";
...
function keyDownHandler(e) {
    ...
    else if (e.key == "Enter") {spacepressed = !spacepressed}
//pause detect 2/3
    ...
    if(pause) {
        ...
        ctx.fillStyle = "white";
        ctx.fillText("PAUSE", canvas.width / 2 - 450, canvas.height / 2 + 100    );
